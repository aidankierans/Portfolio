...
To use this program, run it from the command line with arguments in the following format, where n is the length of the
ngrams, m is the number of sentences to generate, and an arbitrary positive number of arguments following them are file
paths:
...
print("This program generates random sentences based on an Ngram model. Author: Aidan Kierans")
